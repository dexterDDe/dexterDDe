...
@Component({
  ...
  templateUrl: './grupo-tres.page.html',
  styleUrls: ['./grupo-tres.page.scss'],
})
export class GrupoTresPage implements OnInit {
  groupMessages: any[] = []; // Array para almacenar los mensajes del grupo
  groupId: string = '3'; // Asume un ID de grupo para el ejemplo
